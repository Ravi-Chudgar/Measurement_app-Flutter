                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      wl = TextEditingController(
                                          text: k.waistLen);
                                      l = TextEditingController(text: k.length);
                                      c = TextEditingController(text: k.chest);
                                      w = TextEditingController(text: k.waist);
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Material(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      TextEditingController l, w, s, t, k, b, f;

                                      l = TextEditingController(
                                          text: p.slength);
                                      w = TextEditingController(text: p.swaist);
                                      s = TextEditingController(text: p.sseat);
                                      t = TextEditingController(text: p.thigh);
                                      k = TextEditingController(text: p.knee);
                                      b = TextEditingController(text: p.bottom);
